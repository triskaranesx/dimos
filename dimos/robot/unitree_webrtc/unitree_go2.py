...
class UnitreeGo2(WebRTCRobot):
    def __init__(self, 
        ...
        self.map = Map()
        self.map_stream = backpressure(self.map.consume(self.lidar_stream()))
        ...
        self.global_planner = AstarPlanner(
            ...
            set_local_nav=navigate_to_goal_local,
            get_costmap=self.map.costmap,
            get_robot_pos=self.odom().pos,
        )
