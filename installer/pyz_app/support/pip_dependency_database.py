...
RAW_PROJECT_TOML = r"""[build-system]
...
exclude = "^dimos/models/Detic(/|$)|.*/test_.|.*/conftest.py*"
...
# we are waiting for Legion to merge our PR https://github.com/legion1581/unitree_webrtc_connect/pull/46
unitree-webrtc-connect = { git = "https://github.com/leshy/unitree_webrtc_connect.git", rev = "2cbb6ce657383c788f4a48d9d87ecf4b9b7dba1d" }
